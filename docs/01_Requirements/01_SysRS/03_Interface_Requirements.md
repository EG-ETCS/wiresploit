...
<table>
  <tr>
    <td align="center">
      ...
      <br><em> Search with no matches</em>
    </td>
    <td align="center">
      <br>
      <img src="error3.png" alt="Empty State" width="200"/>
      <br><em> Raw error detail fails to load</em>
    </td>
    <td align="center">
      <br>
      <img src="error.png" alt="Loading State" width="200"/>
      <br><em> No logs to search </em>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td align="center">
      <br>
      <img src="session-error1.png" alt="Error State" width="200"/>
      <br><em>Figure 3.7.5a: Search with no matches</em>
    </td>
    <td align="center">
      <br>
      <img src="session-error.png" alt="Loading State" width="200"/>
      <br><em>Figure 3.7.5b: No sessions to search </em>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td align="center">
      ...
      <br><em>Figure 3.8.5a: Search with no matches</em>
    </td>
    <td align="center">
      <br>
      <img src="error-snapshots2.png" alt="Empty State" width="200"/>
      <br><em>Figure 3.8.5b: Error detail fails to load</em>
    </td>
    <td align="center">
      <br>
      <img src="error-snapshots4.png" alt="Loading State" width="200"/>
      <br><em>Figure 3.8.5c: No snapshots to search </em>
    </td>
  </tr>
</table>
...
<table>
  ...
  <td align="center">
      <br>
      <img src="snapshot-light.png" alt="Loading State" width="200"/>
      <br><em>Figure 3.9.2a: Snapshot detail view in light mode.
 </em>
    </td>
    <td align="center">
      <br>
      <img src="snapshot-dark.png" alt="Empty State" width="200"/>
      <br><em>Figure 3.9.2b: Snapshot detail view in dark mode.</em>
    </td>
...
### Consideration : 
- all details in logs or in dashboard is presented in snapshot, not repeated to avoid redundency. <br>
